...
def inserir_devolucao(
    ...
    try:
        ...
        st.error("Erro ao salvar na tabela devolucoes")
        st.error(str(e))
        st.json(dados)
        return False
...
def painel_sc():
            ...
            valor_financeiro = pendente * VALOR_UNITARIO_SACA
            ...
            c5.metric(    "💰 Valor Financeiro",    f"R$ {valor_financeiro:,.2f}"
)
